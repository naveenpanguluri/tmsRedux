                                    ...
                                    this.props.rolesMngtTable.Data.map((x, i) =>
                                        <tr key={x.ID}>
                                            <td className={classNames("row-actions d-flex", { "border-top-0": !i })}>
                                                <i className="far fa-trash-alt text-secondary role-delete mr-3" onClick={() => this.deleteRole(x.ID)}></i>
                                                <i className="fas fa-pencil-alt text-secondary role-edit" onClick={() => this.editRoleManagement(x.ID)}></i>
                                            </td>
                                            <td>{x.RoleCode}</td>
