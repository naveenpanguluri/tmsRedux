...
class ReportArmadaMuatPerHari extends React.Component {
    ...
    render() {
        console.log("armadamuat...", this.props.reportArmadaMuatPerHari);

        let { LoadUnloacOrdersByDates } = this.props.reportArmadaMuatPerHari.Data;
                                ...
                                <div className="row">
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <div className="chart">
                                            ...
                                            <BarChart width={900} height={400} data={LoadUnloacOrdersByDates ? LoadUnloacOrdersByDates : []} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                                    ...
                                    <table className="table">
                                        <thead>
                                            <tr>
                                                <th>Date</th>
                                                {
                                                    Boolean(this.props.reportArmadaMuatPerHari.NumberOfRecords) ?
                                                        this.props.reportArmadaMuatPerHari.Data.LoadUnloacOrdersByDates.map((x, i) =>
