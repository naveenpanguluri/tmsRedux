...
import './armadaBongkarPerHari.scss';
...
import { getavgunloadingperdayreport, modifyArmadaBongkarPerHariTable, getpartners } from '../../../store/viewsactions/report';
...
class ReportArmadaBongkarPerHari extends React.Component {
    constructor(props) {
        super(props);

        this.state = { inbound: true, expeditors: "" }
        this.getPartners();
        this.props.modifyArmadaBongkarPerHariTable({ NumberOfRecords: 0, Data: [] });
    ...
    modalFormSubmit(data) {
        this.props.getavgunloadingperdayreport({
            "Request": {
    ...
    render() {
        ...
        console.log("armadabongkar...", this.props.reportArmadaBongkarPerHari);

        let { LoadUnloacOrdersByDates } = this.props.reportArmadaBongkarPerHari.Data;
                ...
                <div className="ReportArmadaMuatPerHari">
                    ...
                    <div className="tabs-wrap">
                        <div className="tabs-header-wrap">
                            <div className="tabs-title d-none d-md-block d-lg-block active">Report - Armada Bongkar Per Hari</div>
                    ...
                    {
                        Boolean(LoadUnloacOrdersByDates) &&
                        <React.Fragment>
                                ...
                                <div className="row">
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <div className="chart">
                                            ...
                                            <BarChart width={900} height={350} data={LoadUnloacOrdersByDates ? LoadUnloacOrdersByDates : []} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                                ...
                                <div className="row mb-4">
                                    <div className="col-12">
                                        <div className="m-0 total">
                                            Total: {LoadUnloacOrdersByDates ? LoadUnloacOrdersByDates.reduce(function (total, obj) { return total + obj.OrderCount; }, 0) : 0}
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table className="table">
                                        <thead>
                                            <tr>
                                                <th>Date</th>
                                                {
                                                    Boolean(this.props.reportArmadaBongkarPerHari.NumberOfRecords) ?
                                                        this.props.reportArmadaBongkarPerHari.Data.LoadUnloacOrdersByDates.map((x, i) =>

                                                            <th key={i}>{x.Day}</th>

                                                        ) :
                                                        <th className="text-center" colSpan="6">No records found</th>
                                                }
                                            </tr>
                                        </thead>
                                        <tbody>
...
const mapStateToProps = (state) => {
    let { credentials, views } = state,
        { report } = views,
        { reportArmadaBongkarPerHari, reportOrderPerHariSelectBox } = report;
    return { credentials, reportArmadaBongkarPerHari, reportOrderPerHariSelectBox }
};
...
const mapDispatchToProps = dispatch => (
    bindActionCreators({
        ...
        removeloader,
        modifyerror,
        getavgunloadingperdayreport,
        modifyArmadaBongkarPerHariTable,
        getpartners
    }, dispatch)
);

export default connect(mapStateToProps, mapDispatchToProps)(ReportArmadaBongkarPerHari);